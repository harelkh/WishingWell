...
def testrun():
    ...
    share_wishlist('wishlists.server@gmail.com', 'Ardenkt123', '106299@avondaleschool.nsw.edu.au',"A new wishlist has been shared with you!!", "TESTING12345",('wishlists/shrey.somaiya@gmail.com-Valentines'))
    reload()
